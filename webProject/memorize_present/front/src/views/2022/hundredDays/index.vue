<template>
  <div id="hundredDays_2023">
    <div class="first_wrap" v-show="flag == 1">
      <div class="back_wrap"></div>
      <div class="text">
        <div class="animated fadeInDown">小曹老师</div>
        <div class="animated fadeInRight" style="--delay: 1s">
          2022年7月19号21点29分
        </div>
        <div class="animated fadeInDown" style="--delay: 2s">
          小刘迎来了您的第一声打招呼
        </div>

        <div class="animated fadeInDown" style="--delay: 4s; margin-top: 20px">
          眨眼已经过去
        </div>
        <div class="animated fadeInLeft positionWrap" style="--delay: 5s">
          {{ yy }}年{{ dd }}天{{ hh }}小时{{ mm }}分
        ...
        <div class="animated fadeInDown" style="--delay: 7s; margin-top: 20px">
          总计
        </div>
        ...
        <div class="animated fadeInUp" style="--delay: 10s; margin-top: 20px">
          慢慢的经历，磕磕绊绊，甜甜蜜蜜，
          <div class="animated fadeIn" style="--delay: 12s; display: inline">
            但最重要的是小曹不嫌弃，
          </div>
          <div class="animated fadeIn" style="--delay: 13s; display: inline">
            小刘一直在(๑*◡*๑)。
          </div>
        </div>
      </div>
    ...
    <transition enter-active-class="animated fadeIn">
      <div class="second_wrap" v-show="flag == 2">
        ...
        <div class="text">
          ...
          <div class="animated fadeInDown" style="--delay: 1s">
            小曹老师的送给小刘的第一个礼物
          </div>
          <div
            class="animated fadeInLeft"
            style="--delay: 3s; margin-top: 20px"
          >
            叮咚~一声
          </div>
          <div class="animated fadeInDown" style="--delay: 4s">
            一件礼物等待查收
          </div>
          <div class="animated fadeInDown" style="--delay: 5s">拆开礼物</div>
          <div class="animated fadeInDown" style="--delay: 6s">
            开心到小刘同学做梦都是甜的
          </div>
          <div
            class="animated fadeInDown"
            style="--delay: 8s; margin-top: 20px"
          >
            承蒙问候
          </div>
          <div class="animated fadeInDown" style="--delay: 9s">
            走进了我这二十几年无人问津的心
          </div>
    ...
    <transition enter-active-class="animated fadeIn">
      <div class="thrid_wrap" v-show="flag == 3">
        <div v-for="i of 7" :class="activeClass(i) + ' transparent'" :key="i">
          ...
          <div
            class="animated fadeInUp btn"
            style="--delay: 1s"
            v-show="activeImgIndex == 6"
          >
            <div
              class="memorizeBtn"
              @click="
        ...
        <div
          class="change-box"
          style="left: 0"
          @click="activeImgIndex--"
          v-show="activeImgIndex > 1"
        >
...
const message = [
  "在我们认识的这段时间里",
  "微信聊天成了日常",
  '我们聊天使用最频繁的词是"哈哈哈"（确实欢乐）',
  "当然重头还是通话",
  "小曹你知道吗,咱们目前总共打电话211.71小时",
  "也就是说这段时间里咱们促膝长谈了9天,想想就幸福，嘿嘿嘿ヾ(✿ﾟ▽ﾟ)ノ",
];
// 逻辑变量
let imgArr = [];
